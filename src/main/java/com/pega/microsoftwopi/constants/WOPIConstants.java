...
public class WOPIConstants {
    ...
    public static final String EXCEPTION_WOPISERVICE_GETLOGFILE = "Exception in Class:WOPIService Method:getLogFile Exception: ";
    ...
    public static final String LOG_FILE_PATH = "application.log/spring.log";
    ...
    public static final String REST_END_POINT_GET_LOG_FILE = "/files/log";
    ...
    public static final String API_FILE_LOGFILE = "Get log file";
    ...
    public static final String API_LOG_FILE_DOWNLOADED = "Successfully downloaded file";
